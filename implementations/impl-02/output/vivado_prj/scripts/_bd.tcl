...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
j-marjanovic.io:user:ERVP02:0.1\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ERVP02, and set properties
  set ERVP02 [ create_bd_cell -type ip -vlnv j-marjanovic.io:user:ERVP02:0.1 ERVP02 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ERVP02/CTRL] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net ERVP02_uart_tx [get_bd_pins ERVP02/uart_tx] [get_bd_pins zynq_ultra_ps_e_0/emio_uart1_rxd]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_reset [get_bd_pins ERVP02/reset] [get_bd_pins rst_ps8/peripheral_reset]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart1_txd [get_bd_pins ERVP02/uart_rx] [get_bd_pins zynq_ultra_ps_e_0/emio_uart1_txd]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ERVP02/clock] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ERVP02/CTRL/reg0] -force
